...
#ifndef _COINCONNECTRPC_H_
#define _COINCONNECTRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Coinconnect is not connected
...
/**
 * Coinconnect RPC command dispatcher.
 */
class CRPCTable
{
private:
