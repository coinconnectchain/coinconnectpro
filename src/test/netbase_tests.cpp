...
{
    BOOST_CHECK(TestSplitHost("www.coinconnectpro.info", "www.coinconnectpro.info", -1));
    BOOST_CHECK(TestSplitHost("[www.coinconnectpro.info]", "www.coinconnectpro.info", -1));
    BOOST_CHECK(TestSplitHost("www.coinconnectpro.info:80", "www.coinconnectpro.info", 80));
    BOOST_CHECK(TestSplitHost("[www.coinconnectpro.info]:80", "www.coinconnectpro.info", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19990", "127.0.0.1", 19990));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19990", "127.0.0.1", 19990));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19990", "::ffff:127.0.0.1", 19990));
    BOOST_CHECK(TestSplitHost("[::]:19990", "::", 19990));
    BOOST_CHECK(TestSplitHost("::19990", "::19990", -1));
    BOOST_CHECK(TestSplitHost(":19990", "", 19990));
    BOOST_CHECK(TestSplitHost("[]:19990", "", 19990));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19990", "127.0.0.1:19990"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19990", "[::]:19990"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
